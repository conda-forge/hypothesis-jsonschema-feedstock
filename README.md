...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7926&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hypothesis-jsonschema-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hypothesis-jsonschema` can be installed with:

```
conda install hypothesis-jsonschema
```

It is possible to list all of the versions of `hypothesis-jsonschema` available on your platform with:
